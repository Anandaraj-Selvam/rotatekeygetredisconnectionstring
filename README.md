...
# KeyVault-Secrets-Rotation-[Redis]-PowerShell
...
* AKV[Redis]Rotation - event triggered function, performs [Redis] key rotation triggered by Key Vault events. In this setup Near Expiry event is used which is published 30 days before expiration
* AKV[Redis]RotationHttp - on-demand function with KeyVaultName and Secret name as parameters
